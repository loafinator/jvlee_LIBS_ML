...
In order to run this by itself you have to run it in the terminal as:
'py -m util.data_prep'
because of the relative imports (ex. 'from .file_type_processing import _).
The '.' in 'from .file_____' indicates that it is a file in the same 
