...
def full_run(
    ...
    logger_path = Path(rf"G:\My Drive\RLSL\Python\LIBS\LIBS_MLP_003_log\hidden_run_{time_stamp}_{hidden_str}.txt")
    eval_dir = Path(rf"G:\My Drive\RLSL\Python\LIBS\eval_MLP_003\hidden_run_{time_stamp}_{hidden_str}")
    ...
    try:  
        ...
        training_model, history = init_xpu_trainer(
            ...
            verbose= True,
            plot_animation= True,
            save_path= rf"G:\My Drive\RLSL\Python\LIBS\MLP_003_trn_Hist\hidden_run_{time_stamp}_{hidden_str}"
        )
